...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate the fine-tuned ResNet18 model on the test split.")
    parser.add_argument(
        "--model-path",
        default="models/resnet18_finetuned_weighted.pth",
        help="Path to the saved fine-tuned ResNet weights.",
    )
    parser.add_argument(
        "--batch-size",
        type=int,
    ...
    parser.add_argument(
        "--output-file",
        default="reports/resnet18_finetuned_weighted_results.txt",
